...
public interface OrganizationRepository extends JpaRepository<Organization, UUID> {
	...
	@Query("Select new com.prathamesh.tasksphere.dto.OrganizationResponse("
			+ "o.id, o.name, o.description, o.createdAt," + "(Select count(p) from Project p where p.organization = o),"
